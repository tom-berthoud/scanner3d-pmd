...
\begin{frame}[plain]
  ...
  \begin{columns}[T,totalwidth=14.5cm]
    ...
    \begin{column}{0.49\linewidth}
      ...
      \end{beamercolorbox}
      \vspace{0.34cm}
      \redtag{POINT CLÉ} \quad la géométrie est reconstruite depuis le code de calibration
      \vspace{0.38cm}

      \begin{tabular}{@{}lr@{}}
        \toprule
        Paramètre code & Valeur actuelle \\
        \midrule
        vues par tour & 100 \\
        ligne minimale & 4 pixels \\
        filtre outliers & 20 voisins, $2\sigma$ \\
        sortie par défaut & STL \\
        \bottomrule
      \end{tabular}
    \end{column}
  \end{columns}
...
\begin{frame}[plain]
  ...
  \begin{columns}[T,totalwidth=14.5cm]
    \begin{column}{0.51\linewidth}
      \begin{tikzpicture}
        \node[inner sep=0pt] at (0,0) {\includegraphics[width=3.15cm,height=3.15cm,keepaspectratio]{carre_nuage.png}};
        \node[inner sep=0pt] at (3.25,0) {\includegraphics[width=3.15cm,height=3.15cm,keepaspectratio]{carre_gris_stl.png}};
        \node[inner sep=0pt] at (0,-3.25) {\includegraphics[width=3.15cm,height=3.15cm,keepaspectratio]{screen_cylindre_nuage.png}};
        \node[inner sep=0pt] at (3.25,-3.25) {\includegraphics[width=3.15cm,height=3.15cm,keepaspectratio]{screen_cylindre_stl.png}};
    ...
    \begin{column}{0.46\linewidth}
      ...
      \IfFileExists{assets/video_35s.mp4}{%
        \vspace{-2.45cm}
        \movie[width=6.1cm,height=2.35cm,poster,showcontrols]{\includegraphics[width=6.1cm,height=2.35cm]{screen_interface.png}}{assets/video_35s.mp4}
      }{}
      \vspace{0.25cm}
