...
\begin{itemize}
  ...
  \item le \textbf{coût réel pour l'école} : la dépense effectivement engagée.
        ...
        se résume donc aux pièces effectivement commandées.
\end{itemize}
...
projet des composants \emph{issus du stock} du MakeLab, dont le prix est
estimé au prix de marché pour l'estimation du prototype.
...
se limite aux deux commandes passées pour le projet.
...
\begin{table}[H]
  ...
  \begin{tabular}{@{}p{8cm}r@{}}
    ...
    \bottomrule
  \end{tabular}
  \caption{Coût réel engagé pour le projet.}
