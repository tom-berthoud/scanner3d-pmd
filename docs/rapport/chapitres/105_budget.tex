...
\begin{table}[H]
  ...
  \begin{tabular}{@{}p{5cm}r r r@{}}
    ...
    Impression 3D        & 35\,h  & 40\,CHF/h  & 1\,400\,CHF \\
    Découpe laser        & 3\,h   & 50\,CHF/h  & 150\,CHF \\
    Pièces achetées      & ---    & ---        & $\approx$\,450\,CHF \\
    \midrule
    \textbf{Total estimé} & & & $\approx$\,\textbf{52\,860\,CHF} \\
    \bottomrule
  \end{tabular}
...
\begin{table}[H]
  ...
  \begin{tabular}{@{}p{6.5cm}p{2.2cm}r p{2.3cm}@{}}
    ...
    2$\times$ caméra USB OV9726 (720p)     & Commandé    & 17.60\,CHF & Galaxus \\
    ...
    Alimentation 12\,V 36\,W (Hama)        & Stock       & $\approx$\,25\,CHF & --- \\
    Convertisseur 12$\to$5\,V LM2596       & Stock       & $\approx$\,4\,CHF  & --- \\
    ...
    \midrule
    \textbf{Total estimé (prix de marché)} & & \textbf{$\approx$\,450\,CHF} & \\
    \bottomrule
  \end{tabular}
...
des composants au prix de marché ($\approx$\,450\,CHF,
...
Raspberry Pi, qui pourraient être mutualisés ou remplacés par des variantes
moins coûteuses dans une version optimisée.
