...
jusqu'au fichier exploitable. Il comprend la boîte, le plateau rotatif,
...
prototype doit rester compréhensible par les utilisateurs du MakeLab et
modifiable par une équipe qui reprendrait le projet.

\subsection{Principe de mesure}

L'objet à numériser est placé sur un plateau rotatif dans une boîte fermée. Un
...
être étudiée séparément. La boîte réduit l'influence de la lumière ambiante
...
\begin{table}[H]
  ...
  \begin{tabular}{@{}p{1.2cm}p{12.5cm}@{}}
    ...
    \midrule
    O1 & Numériser automatiquement un objet jusqu'à $150\times150\times150$\,mm (E1, E3). \\
    O2 & Produire un fichier STL ou OBJ (E6). \\
    O3 & Réaliser un cycle complet en moins de 10\,minutes (besoin utilisateur B4 du cahier des charges). \\
    O4 & Permettre une prise en main en moins de 10\,minutes et 90\,\% de scans sans assistance sur 10 essais (E7). \\
    O5 & Limiter les dépenses du projet à 300\,CHF (E16). \\
    O6 & Protéger l'utilisateur du laser et des parties mobiles (E17, E18, E19). \\
    O7 & Fournir un retour visuel de l'état du système (E5). \\
    O8 & Commander le scanner par interface web ou USB en cinq actions au plus (E10, E11). \\
    O9 & Atteindre une erreur moyenne $\leq 2$\,mm et une répétabilité $\leq 1$\,mm (E24). \\
    O10 & Respecter un encombrement $\leq 500^3$\,mm et une masse $\leq 15$\,kg (E21). \\
    O11 & Traiter les objets sans cavité fermée ni contre-dépouille supérieure à $45^\circ$ (E23). \\
    \bottomrule
  \end{tabular}
...
L'ensemble des fichiers sources (code, fichiers de fabrication mécaniques et
électroniques, et ce rapport) est disponible sur le dépôt public du projet :
\url{https://github.com/tom-berthoud/scanner3d-pmd}.
